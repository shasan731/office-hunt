...
export abstract class BaseScene extends Phaser.Scene {
  ...
  private keyToStage(): 'commute' | 'lobby' | 'coding' | 'work-gauntlet' | 'lunch' | 'fight' | 'tea-break' | 'hr-search' | 'salary' | 'escape' | 'results' {
    const map: Record<string, 'commute' | 'lobby' | 'coding' | 'work-gauntlet' | 'lunch' | 'fight' | 'tea-break' | 'hr-search' | 'salary' | 'escape' | 'results'> = {
      CommuteScene: 'commute', LobbyScene: 'lobby', CodingScene: 'coding', HRSearchScene: 'hr-search',
      WorkGauntletScene: 'work-gauntlet', LunchScene: 'lunch', FightScene: 'fight', TeaBreakScene: 'tea-break', SalaryScene: 'salary', EscapeScene: 'escape', ResultsScene: 'results',
    };
